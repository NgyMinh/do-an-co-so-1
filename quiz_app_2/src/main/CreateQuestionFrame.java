    ...
    private class SaveAllQuestionsListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (subCategory == null || subCategory.isEmpty()) {
                JOptionPane.showMessageDialog(CreateQuestionFrame.this, "Vui lòng chọn lĩnh vực cụ thể.", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            for (Question question : temporaryQuestions) {
                try {
                    ...
                    JOptionPane.showMessageDialog(CreateQuestionFrame.this, "Lỗi khi lưu câu hỏi: " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            ...
            JOptionPane.showMessageDialog(CreateQuestionFrame.this, "Tất cả câu hỏi đã được lưu và lĩnh vực đã được thêm vào Menu!", "Thành công", JOptionPane.INFORMATION_MESSAGE);
